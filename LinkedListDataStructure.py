...
class LinkedList:
    ...
    def addAfter(self, val, pos, linklist):
        """
        1. copy the og list
        2. remove the item at certain pos by calling atIndex and remove func simultaneously
        3. put the val of new node next to that pos
        4. reorganize the removed items again on top of the new node
        """
...
cnt = 1
def test_counter():
    global cnt; print(f"Test {cnt}".center(50, "=")); cnt+=1;
